...
export const MenuItem = ({
    ...
    return (
        <>
            {href ? (
                <HoveredLink href={href} className="relative">
                    <motion.p
...
export const ProductItem = ({
    ...
    return (
        <a onClick={handle} href={href} className="flex space-x-2">
            <img
                src={src}
                width={140}
                height={70}
...
export const HoveredLink = ({ children, ...rest }: any) => {
    return (
        <a
            {...rest}
            className="text-neutral-700 dark:text-neutral-200  font-normal"
        >
            {children}
        </a>
    );
