            ...
            {items.map((item, idx) => (
                ...
                >
                    <AnimatePresence>
                        {hoveredIndex === idx && (
                            <motion.span
                                className="absolute inset-0 h-full w-full bg-neutral-200 dark:bg-slate-75/[0.8] block  rounded-3xl"
                    ...
                    <Card>
                        ...
                        <img src={ApiService.URL + "/img" + item.ruta_img} width={150}></img>
                        <CardDescription>S/.{item.precio} <br /> <b>{item.marca}</b></CardDescription>
                    </Card>
                </a>
            ))
            }
